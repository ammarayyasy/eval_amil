...
<body>
    <div class="container">
        ...
        <form action="/edit/form/atasan/{{ $form->id }}" method="post"  enctype="multipart/form-data">
            @csrf
            @method('put')
        <!-- table -->
        <div class="row">
        ...
        <div class="col-6"><textarea name="view_atasan_1" id="view_atasan_1" placeholder="Isi disini..." >{{ $form->view_atasan_1 }}</textarea></div>
        <div class="col-5">Aspek apa saja yang menjadi kelebihan/kekuatan Amil?</div>
        <div class="col-6"><textarea name="view_atasan_2" id="view_atasan_2" placeholder="Isi disini..." >{{ $form->view_atasan_2 }}</textarea></div>
        <div class="col-5">Aspek apa saja yang menjadi kekurangan/kelemahan Amil?</div>
        <div class="col-6"><textarea name="view_atasan_3" id="view_atasan_3" placeholder="Isi disini..." >{{ $form->view_atasan_3 }}</textarea></div>
        <div class="col-5">Bagaimana kinerja amil atas target pekerjaan yang diberikan?</div>
        <div class="col-6"><textarea name="view_atasan_4" id="view_atasan_4" placeholder="Isi disini..." >{{ $form->view_atasan_4 }}</textarea></div>
        <div class="col-5">Apa yang dapat Amil lakukan untuk meningkatkan kompetensi dan efektifitas kerja?</div>
        <div class="col-6"><textarea name="view_atasan_5" id="view_atasan_5" placeholder="Isi disini..." >{{ $form->view_atasan_5 }}</textarea></div>
        <div class="col-5">Pelatihan tambahan apa yang dapat bermanfaat bagi Amil?</div>
        <div class="col-6"><textarea name="view_atasan_6" id="view_atasan_6" placeholder="Isi disini..." >{{ $form->view_atasan_6 }}</textarea></div>
        <div class="row">
            <div class="col-1">Rekomendasi:</div>
            <div class="col-2">
                <select name="view_atasan_7" id="view_atasan_7">
        ...
        <div class="row mt">
            <div class="col-ttd">
                ...
                <div class="col-ttd-bot">
                   ...
                   <div class="col-date"><input id="ttd_atasan_tgl" name="ttd_atasan_tgl" type="date" value={{ $form->ttd_atasan_tgl }}></div>
                </div>
            </div>
            <div class="col-ttd">
        ...
        <script>
            function previewImageAtasan() {
                const ttd_atasan = document.querySelector('#ttd_atasan');
                const imgPreviewAtasan = document.querySelector('.img-preview-atasan');

                imgPreviewAtasan.style.display = 'block';

                const oFReader = new FileReader();
                oFReader.readAsDataURL(ttd_atasan.files[0]);

                oFReader.onload = function(oFREvent) {
                    imgPreviewAtasan.src = oFREvent.target.result;
                }
            }
        </script>
